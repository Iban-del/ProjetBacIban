...
function loadPage(name,now = false){
    const baseUrl = "https://projet-bac-iban.vercel.app/html/"
        ...
        if(e){
            ...
            switch(code){
                ...
                case 'Digit4':
                    ...
                    break;
                case 'KeyL':
                    document.location.href = "https://www.linkedin.com/in/iban-deletoille-elizalde-2a5780335?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app"
                    break;
