...
/**
 * Affichage de la vague avec un dégradé vers #BB86FC en bas
    ...
    if (ctx instanceof CanvasRenderingContext2D) {
        ...
        for (let t = -200; t < canvas.height + 200; t += 100) {
            ...
            for (let i = 0; i < canvas.width; i += 5) {
                ...
                let globalColor = `rgb(${red}, ${green}, ${blue})`;
            ...
            color += 20; // Augmentation progressive des couleurs
        }
    }
}
